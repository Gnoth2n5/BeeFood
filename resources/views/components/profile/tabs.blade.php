...
<div class="border-t border-gray-200">
    <nav class="flex space-x-8 px-6" aria-label="Tabs">
        ...
        <button wire:click="setActiveTab('vip')" class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'vip' ? 'border-orange-500 text-orange-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
            VIP & Cửa hàng
        </button>
    </nav>
</div> 
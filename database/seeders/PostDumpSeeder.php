...
class PostDumpSeeder extends Seeder
{
    /**
     * Run the seeder.
     */
    public function run(): void
    {
        ...
        $data = [
            [
                ...
                'slug' => '10-meo-nau-an-co-ban-cho-nguoi-moi-bat-dau',
...
<p>Dọn dẹp bếp trong khi nấu sẽ giúp bạn có không gian thoải mái và dễ dàng hoàn thành món ăn.</p>',
                ...
                'featured_image' => 'posts/01K2993PAG1KV5HEZDMEXP4CRR.jpg',
                'status' => 'published',
                'published_at' => '2025-08-03 05:52:41',
                'user_id' => 1,
                'view_count' => 1310,
                'meta_title' => null,
                ...
                'updated_at' => '2025-08-21 04:25:03',
                'deleted_at' => null,
            ],
            [
                'id' => 2,
                'title' => 'Cách Làm Bánh Mì Việt Nam Truyền Thống',
                'slug' => 'cach-lam-banh-mi-viet-nam-truyen-thong',
...
<p>Để bánh mì có vỏ giòn, hãy phun nước vào lò nướng trong 5 phút đầu. Nhiệt độ cao sẽ tạo ra lớp vỏ giòn đặc trưng của bánh mì Việt Nam.</p>',
                ...
                'featured_image' => null,
                'status' => 'published',
                'published_at' => '2025-08-05 05:52:41',
                'user_id' => 4,
                'view_count' => 915,
                'meta_title' => null,
                'meta_description' => null,
                'meta_keywords' => null,
                'created_at' => '2025-08-08 05:52:41',
                'updated_at' => '2025-08-21 04:43:35',
                'deleted_at' => null,
            ],
            [
                'id' => 3,
                'title' => 'Top 5 Loại Gia Vị Không Thể Thiếu Trong Bếp Việt',
                'slug' => 'top-5-loai-gia-vi-khong-the-thieu-trong-bep-viet',
...
<p>Bảo quản gia vị trong hộp kín, tránh ánh nắng trực tiếp và độ ẩm cao để giữ được hương vị lâu nhất.</p>',
                ...
                'featured_image' => null,
                'status' => 'published',
                'published_at' => '2025-08-07 05:52:41',
                'user_id' => 2,
                'view_count' => 567,
                'meta_title' => null,
                'meta_description' => null,
            ...
            [
                ...
                'slug' => 'cach-chon-va-bao-quan-rau-cu-qua-tuoi',
...
<p>Không rửa rau củ trước khi bảo quản, chỉ rửa khi sử dụng để tránh bị thối rữa.</p>',
                ...
                'featured_image' => null,
                'status' => 'published',
                'published_at' => '2025-08-07 17:52:41',
                'user_id' => 1,
                'view_count' => 234,
                'meta_title' => null,
                'meta_description' => null,
            ...
            [
                ...
                'slug' => 'cong-thuc-lam-nuoc-mam-pha-san-chuan-vi',
                'content' => '<h2>Nguyên liệu cần thiết</h2>
<ul>
...
<p>Luôn nếm thử và điều chỉnh theo khẩu vị. Nước mắm pha sẵn có thể bảo quản trong tủ lạnh 1-2 tuần.</p>',
                ...
                'featured_image' => null,
                'status' => 'published',
                'published_at' => '2025-08-07 23:52:41',
                'user_id' => 4,
                'view_count' => 134,
                'meta_title' => null,
                'meta_description' => null,
                'meta_keywords' => null,
                'created_at' => '2025-08-08 05:52:41',
                'updated_at' => '2025-08-21 05:58:38',
                'deleted_at' => null,
            ],
        ];

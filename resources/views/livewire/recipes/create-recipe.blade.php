<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Tạo Công Thức Mới</h1>
            <p class="mt-2 text-gray-600">Chia sẻ công thức nấu ăn của bạn với cộng đồng</p>
        </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-green-700">
                            <p>Công thức của bạn đã được tạo thành công và đang chờ duyệt. Bạn sẽ được thông báo khi công thức được phê duyệt.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form wire:submit.prevent="save" class="space-y-8">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Định dạng: JPEG, PNG, JPG, GIF, WebP. Tối đa 2MB.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-6">
                ...
                <button type="submit" 
                    ...
                    <span wire:loading.remove wire:target="save">Tạo Công Thức</span>
    ...
    <!-- JavaScript for redirect after creation -->
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('recipe-created', (event) => {
                setTimeout(() => {
